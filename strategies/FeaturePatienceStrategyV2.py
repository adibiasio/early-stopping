...
from .PolynomialAdaptivePatienceStrategyV2 import (
    PolynomialAdaptivePatienceStrategyV2,
)


class FeaturePatienceStrategyV2(PolynomialAdaptivePatienceStrategyV2):
    """
